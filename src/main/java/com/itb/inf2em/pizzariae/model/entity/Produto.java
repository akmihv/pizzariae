...
@Entity
@Table(name = "Produto")        // O uso @Table é facultativo quando o nome da classe é igual ao nome da tabela
public class   Produto {
    ...
    @Column(columnDefinition = "DECIMAL(5,2)", nullable = true)     // DECILAM(5,2) Ex: valor até R$ 99.999,99
